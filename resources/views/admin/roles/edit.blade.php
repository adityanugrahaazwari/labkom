...
@section('title', 'Edit Peran (Role)')
@section('subtitle', 'Perbarui konfigurasi hak akses dan informasi peran.')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <input 
                    ...
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition text-sm font-mono bg-slate-50 text-slate-500 @error('name') border-red-500 @enderror"
                    placeholder="Contoh: kepala-lab"
                    required
                    readonly
                >
                <p class="text-[10px] text-slate-400">Kode identifikasi sistem tidak dapat diubah setelah dibuat.</p>
                @error('name')
                    <p class="text-xs text-red-500">{{ $message }}</p>
                @enderror
            </div>
