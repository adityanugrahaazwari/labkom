...
@section('subtitle', 'Perbarui konfigurasi rute, posisi, urutan, atau hak akses menu navigasi.')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 col-span-2 md:col-span-1">
                ...
                <select 
                    ...
                    required
                >
                    <option value="header" {{ old('position', $menu->position) === 'header' ? 'selected' : '' }}>Header Navigation (Publik)</option>
                    <option value="sidebar" {{ old('position', $menu->position) === 'sidebar' ? 'selected' : '' }}>Sidebar Navigation (Admin)</option>
                </select>
                @error('position')
                    <p class="text-xs text-red-500">{{ $message }}</p>
                @enderror
            ...
            <div class="space-y-2 col-span-2 md:col-span-1">
                ...
                <select 
                    ...
                    required
                >
                    <option value="_self" {{ old('target', $menu->target) === '_self' ? 'selected' : '' }}>Buka di Tab yang Sama (_self)</option>
                    <option value="_blank" {{ old('target', $menu->target) === '_blank' ? 'selected' : '' }}>Buka di Tab Baru (_blank)</option>
                </select>
            </div>
            ...
            <div class="space-y-2 col-span-2">
                ...
                >
                    ...
                    @foreach($permissions as $perm)
                        <option value="{{ $perm->id }}" {{ old('permission_id', $menu->permission_id) == $perm->id ? 'selected' : '' }}>
