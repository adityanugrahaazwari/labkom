...
@section('subtitle', 'Buat agenda kegiatan baru di Laboratorium.')

@section('content')
<div class="max-w-4xl bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
    <form action="{{ route('admin.agenda.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 col-span-2">
                ...
                <input 
                    ...
                    placeholder="Contoh: Seminar Cybersecurity & Cloud Computing"
                    required
                >
                @error('title')
            ...
            <div class="space-y-2">
                ...
                <input 
                    ...
                    value="{{ old('location') }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition text-sm font-medium"
                    placeholder="Contoh: Lab Jaringan (Gedung B Lt. 3)"
                    required
                >
                @error('location')
                    <p class="text-xs text-rose-500 mt-1">{{ $message }}</p>
            ...
            <div class="space-y-2 col-span-2">
                ...
                <textarea 
                    ...
                    placeholder="Tulis susunan acara, pemateri, and keterangan lengkap di sini..."
                    required
            ...
            <!-- Image Banner -->
            <div class="space-y-2 col-span-2">
                <label class="text-sm font-semibold text-slate-700 block">Poster / Gambar Agenda (Opsional)</label>
